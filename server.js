...
// app.use([optaional:starts with path(like:app.use('/', indexRouter);)], <middleware fn> [, <middleware fn>])

app.use(function(req, res, next) {
  console.log('Hello SEI!')
  // Add a time property to the res.locals objects
...
// Process data sent in 'form' body of the request.
